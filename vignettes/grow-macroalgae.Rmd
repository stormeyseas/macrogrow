...
# Molar mass of nitrogen (g mol-1), used for mass <-> molar conversions
N_molar_mass <- 14.007
...
# mgN m-3 is numerically equal to ugN L-1; divide by molar mass to get umolN L-1
env$nitrate_uM <- env$nitrate / N_molar_mass
env$ammonium_uM <- env$ammonium / N_molar_mass
```
...
# 0.005 g L-1 converted to mg m-3 (x 1000 mg/g, x 1000 L/m3)
init_biomass <- 0.005 * 1000 * 1000
